...
const NavBar = () => {
  ...
  const imageUrl = user
    ? `${process.env.NEXT_PUBLIC_POCKETBASE_URL}/api/files/_pb_users_auth_/${user.id}/${user.avatarUrl}`
    : "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp";

  return (
    <div className="navbar bg-base-100 shadow-sm rounded-xl py-6">
      <div className="flex-1">
        <a className="btn btn-ghost text-xl">Daikin Shop</a>
      </div>
